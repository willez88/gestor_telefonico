"""
Django settings for gestor_telefonico project.
...
ALLOWED_HOSTS = [u'willez2.pythonanywhere.com']
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_TEMPLATES,USUARIO_TEMPLATES],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'gestor_telefonico.wsgi.application'
